...
const SECTIONS = [
  ...
  { h: "4. Yield & Accrual", p: "Each vault carries a fixed total return, paid in full by the end of its lock period. Profit accrues continuously, computed per second against staked principal, and is displayed live on the member dashboard. Fixed-term vaults mature at their stated duration, after which principal and yield are withdrawable. An automated server engine advances accrual; the protocol may also apply manual yield adjustments." },
